...
import { DuneError, ExecutionState, } from "../types";
...
export class DuneClient {
     ...
     * @returns
     */
    async refreshResults(queryId, params, pingFrequency = POLL_FREQUENCY_SECONDS) {
        log.info(logPrefix, `refreshing query https://dune.com/queries/${queryId} with parameters ${JSON.stringify(params)}`);
        ...
        while (!TERMINAL_STATES.includes(status.state)) {
            log.info(logPrefix, `waiting for query execution ${execution_id} to complete: current state ${status.state}`);
